...
<nav>
       			 <div class="logo">
       			     <a href="main.jsp">My <em>Journey</em> <b><font size="6" color="gray">Sign Up</font></b></a>
       			 </div>
      			  <div class="menu-icon">
      			  <span></span>
     			 </div>
 	...
 	<div class="container"> <!-- 컨테이너 클래스 이용 -->
 		...
 		<div class="col-lg-4">
 			<div class="jumbotron" style="padding-top: 20px;"> <!-- 점보트론 박스 이용. 중앙에서 시작할수있게 탑에서 20패딩 -->
                ...
                <div class="form-group">
                	<input type="text" class="form-control" placeholder="Email Address" name="userEmail" maxlength="30">
                </div>
