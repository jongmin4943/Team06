...
">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<td><a style="float:left" href="boardView.jsp?no=<%=v.get(i).getNo()%>&currPage=<%=tempStart%>&cate=<%=cate%>&keyword=<%=keyword%>"><%=v.get(i).getTitle()%></a><h6 style="color:#afafaf;font-size:16px;font-weight:500;">&nbsp;[<%=v.get(i).getCountCom()%>]</h6></td>
