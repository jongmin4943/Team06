...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="index.html">My <em>Travel</em></a>
        </div>
        <div class="menu-icon">
        <span></span>
      </div>
    ...
    <div id="video-container">
        ...
        <div class="video-content">
            <div class="inner">
              <h1>Welcome to <em>MyTravel</em></h1>
        ...
        <div class="container-fluid">
            <div class="col-md-4 col-sm-6">
                <div class="portfolio-item">
                    ...
                    <a href="http://localhost:8080/MyTravel/myList.jsp">
      ...
      <div class="container">
        <div class="row">
          <div class="main-menu">
              <ul>
                  <li>
                      <a href="http://localhost:8080/MyTravel/index.html">Home</a>
                  </li>
                  <li>
                      <a href="http://localhost:8080/MyTravel/signIn.jsp">Sign - In</a>
                  </li>
                  <li>
                      <a href="http://localhost:8080/MyTravel/myList.jsp">My Trips</a>
                  </li>
                  <li>
                      <a href="http://localhost:8080/MyTravel/aboutUs.jsp">About Us</a>
                  </li>
              </ul>
